...
//  {Dynamic Programming}
//---------------------------------------------------------------------------
//  Calculating the maximum HN of type integer (32 bits)
//
//  Status: Completed
//---------------------------------------------------------------------------
#include <vcl.h>
...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	std::wcout << L"Calculating the maximum HN of type integer (32 bits)" << std::endl;
	...
	while(true)
	{
		...
		else
		{
			if(intHN > intHNmax)
			{
				vectorHNS.push_back(intHNmax = intHN);
			}
			else
			{
				break;
...

	{
		...
		wss << L"Max HN type integer (32 bits): " << intHNmax << std::endl;
