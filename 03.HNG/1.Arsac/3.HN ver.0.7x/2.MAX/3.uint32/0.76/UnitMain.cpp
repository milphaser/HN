...
//  {Dynamic Programming}
//---------------------------------------------------------------------------
//  Calculating the maximum HN of type unsigned integer (32 bits)
//
//  Status: Completed
//---------------------------------------------------------------------------
#include <vcl.h>
...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	std::wcout << L"Calculating the maximum HN of type unsigned integer (32 bits)" << std::endl;
	...
	while(true)
	{
		...
		else
		{
			if(uintHN > uintHNmax)
			{
				vectorHNS.push_back(uintHNmax = uintHN);
			}
			else
			{
				break;
...

	{
		...
		wss << L"Max HN type unsigned integer (32 bits): " << uintHNmax << std::endl;
