...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	if(of)
	{
		...
		//	pi/4 = 4 arctan(1/5) - arctan(1/239)
		static auto pi_qurter_approximation_ext = arctan_1_5;
		...
		static auto pi_qurter_approximation = MW::split_hi<MW_SIZE>(pi_qurter_approximation_ext);
		static auto digits = pi_qurter_approximation.digits;
		static auto digits_dec = pi_qurter_approximation.digits_dec;
