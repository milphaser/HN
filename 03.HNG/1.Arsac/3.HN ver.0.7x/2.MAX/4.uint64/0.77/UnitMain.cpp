...
//  {Dynamic Programming}
//---------------------------------------------------------------------------
//  Calculating the maximum HN of type unsigned integer (64 bits)
//
//  Status: Completed
//---------------------------------------------------------------------------
#include <vcl.h>
...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	std::wcout << L"Calculating the maximum HN of type unsigned integer (64 bits)" << std::endl;
	...
	while(true)
	{
		...
		else
		{
			if(ullHN > ullHNmax)
			{
				vectorHNS.push_back(ullHNmax = ullHN);
			}
			else
			{
				break;
...

	{
		...
		wss << L"Max HN type unsigned integer (64 bits): " << ullHNmax << std::endl;
